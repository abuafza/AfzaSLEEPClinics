// Product Recall form using jQuery product-recal.html
$(document).ready(function(){

    $("#submit").click(function(){
        var fname = $("#name").val();
    //   alert(name);
        $("h2.msg").html("Thank you " + fname + ", We will contact with you");
...
// for chart disorder.html information6

const ctx = document.getElementById("chart").getContext('2d');
const myChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Sleep Apnea", "Obstructive Sleep Apnea", "Total"],
    datasets: [{
      label: 'disease',
      data: [0.162, 1.026, 5.4],
